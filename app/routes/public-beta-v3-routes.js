...
*/
router.post('/public-beta-v3/prototype-set-up', function (req, res) {

  if (req.session.data['set-journey'].includes('public-8'))   {
        
    res.redirect('/public-beta-v3/chs-home')
  }
    ...
    res.redirect('/public-beta-v3/choose-sign-in')
 ...
 */
 router.post('/public-beta-v3/choose-sign-in', function (req, res) {
      ...
      */
       ...
       */ 
        ...
        res.redirect('/public-beta-v3/sign-in-using-one-login')
...
router.post('/public-beta-v3/chs-sign-in-password', function (req, res) {
    ...
    if (req.session.data['set-journey'].includes('public-11'))   {
      ...
      res.redirect('/public-beta-v3/your-details-public-beta')
    }
    else if (req.session.data['set-journey'].includes('public-7'))   {
      
      res.redirect('/public-beta-v3/chs-home-signed-in')
    }
    else if (req.session.data['set-journey'].includes('public-8'))   {
...
router.post('/public-beta-v3/create-or-sign-in', function (req, res) {

  if (req.session.data['set-journey'].includes('public-1'))   {
          
    res.redirect('/public-beta-v3/start-page')
  }
  else if (req.session.data['set-journey'].includes('public-2'))   {
...
//start page
router.post('/public-beta-v3/start-page', function (req, res) {
...
//One login sign in
router.post('/public-beta-v3/one-login-enter-password', function (req, res) {
  ...
  //sign in
  router.post('/public-beta-v3/enter-code', function (req, res) {

    if (req.session.data['set-journey'].includes('public-11')) 
    {

      res.redirect('/public-beta-v3/link-to-existing-chs-account') 
      
    }
    else if (req.session.data['set-journey'].includes('public-1'))   {
          
      res.redirect('/public-beta-v3/company-lookup')
    }
    else if (req.session.data['set-journey'].includes('public-2'))   {
    ...
    else if (req.session.data['set-journey'].includes('public-3-4'))      
    {
      ...
      res.redirect('/public-beta-v3/one-login-email-address-updated') 
       
    }
    else if (req.session.data['set-journey'].includes('public-5'))      
    {
              
      res.redirect('/public-beta-v3/one-login-email-matches-different-chs-account') 
         
    }
    else if (req.session.data['set-journey'].includes('public-8'))      
    {
              
      res.redirect('/public-beta-v3/end-linking') 
  ...
  router.post('/public-beta-v3/create-enter-email', function (req, res) {

    if (req.session.data['set-journey'] === 'public-beta-already-linked') {
        
      res.redirect('/public-beta-v3/you-have-a-login')
    }
    else{
  ...
  router.post('/public-beta-v3/create-check-your-email', function (req, res) {
  ...
  //One loginsign create - check email 
  router.post('/public-beta-v3/create-enter-password', function (req, res) {
  
    res.redirect('create-choose-security-type')
  })
  
  //One loginsign create - check email 
  router.post('/public-beta-v3/create-choose-security-type', function (req, res) {
  ...
  router.post('/public-beta-v3/create-set-up-auth-app', function (req, res) {
  ...
  router.post('/public-beta-v3/create-enter-mobile-number', function (req, res) {
   ...
   */
  router.post('/public-beta-v3/create-check-your-phone', function (req, res) {
...
*/
  ...
  router.post('/public-beta-v3/create-complete', function (req, res) {
...
router.post('/public-beta-v3/one-login-email-address-updated', function (req, res) {
  ...
  router.post('/public-beta-v3/link-to-existing-chs-account', function (req, res) {
  ...
  router.post('/public-beta-v3/name', function (req, res) {
  ...
  //One loginsign create complete
  router.post('/public-beta-v3/email-preferences', function (req, res) {
  ...
  router.post('/public-beta-v3/existing-webfiling-account', function (req, res) {
  ...
  // WebFiling sign in 
  router.post('/public-beta-v3/webfiling-sign-in', function (req, res) {
   ...
   router.post('/public-beta-v3/webfiling-mfa', function (req, res) {
  ...
  router.post('/public-beta-v3/link-webfiling-accounts', function (req, res) {
  ...
  router.post('/public-beta-v3/end-linking', function (req, res) {


    if (req.session.data['set-journey'] === 'public-8') {
        
      res.redirect('/public-beta-v3/chs-one-login-settings')
    }
    else{
  ...
  */
    ...
    * Add a company
    */
    router.post('/public-beta-v3/add-a-company', function (req, res) {
    ...
    */
    router.post('/public-beta-v3/confirm-company-details', function (req, res) {
       ...
       * authentication code 
       */ 
      router.post('/public-beta-v3/authentication-code', function (req, res) {
       ...
       * Manage account page
       */ 
         router.post('/public-beta-v3/chs-one-login-settings', function (req, res) {
       ...
       */ 
       router.post('/public-beta-v3/name-account', function (req, res) {
       ...
       */ 
      router.post('/public-beta-v3/email-preferences-ch', function (req, res) {
       ...
       */ 
      router.post('/public-beta-v3/email-preferences-ur', function (req, res) {
