...
//journey setting
router.post('/v7/prototype-set-up', function (req, res) {
...
//start page
router.post('/v7/enter-email-address', function (req, res) {
...
router.post('/v7/one-login-enter-password', function (req, res) {
  ...
  router.post('/v7/create-enter-email', function (req, res) {
  
    res.redirect('create-check-your-email')
  })
  
  //One loginsign create - check email 
  router.post('/v7/create-check-your-email', function (req, res) {
  ...
  //One loginsign create - check email 
  router.post('/v7/create-enter-password', function (req, res) {
  
    res.redirect('create-choose-security-type')
  })
  
  //One loginsign create - check email 
  router.post('/v7/create-choose-security-type', function (req, res) {
  ...
  router.post('/v7/create-set-up-auth-app', function (req, res) {
  ...
  router.post('/v7/create-enter-mobile-number', function (req, res) {
  
    res.redirect('create-check-your-phone')
  })
  
  //One loginsign enter mobile number
  router.post('/v7/create-check-your-phone', function (req, res) {
  ...
  //One loginsign create complete
  router.post('/v7/email-preferences', function (req, res) {
  ...
  router.post('/v7/existing-webfiling-account', function (req, res) {
  ...
  // WebFiling sign in 
  router.post('/v7/webfiling-sign-in', function (req, res) {
   ...
   router.post('/v7/webfiling-mfa', function (req, res) {
  ...
  router.post('/v7/link-webfiling-accounts', function (req, res) {
  ...
  router.post('/v7/existing-account', function (req, res) {
  ...
  //Save your Companies House information
  router.post('/v7/link-accounts', function (req, res) {
  ...
  //do not save things on their account
     ...
     // Companies House sign in 
  router.post('/v7/end-linking', function (req, res) {


    if (req.session.data['set-journey'].includes('filer')) {
       
      res.redirect('/v7/company-lookup')
    }
    else{
  ...
  */
    ...
    * Add a company
    */
    router.post('/v7/add-a-company', function (req, res) {
    ...
    */
    router.post('/v7/confirm-company-details', function (req, res) {
       ...
       * authentication code 
       */ 
      router.post('/v7/authentication-code', function (req, res) {
       ...
       * Manage account page
       */ 
         router.post('/v7/chs-one-login-settings', function (req, res) {
       ...
       */ 
       router.post('/v7/name-account', function (req, res) {
       ...
       */ 
      router.post('/v7/email-preferences-ch', function (req, res) {
       ...
       */ 
      router.post('/v7/email-preferences-ur', function (req, res) {
