...
router.post('/v9-your-companies/upload-a-document', function (req, res) {
...
router.post('/v9-your-companies/choose-sign-in', function (req, res) {
  ...
  if (req.session.data['sign-in-using'] === 'OL') {
      ...
      */
      ...
      if (req.session.data['set-journey'].includes('public-beta-not-linked')){
        ...
        res.redirect('/v9-your-companies/start-page')
   ...
   */
    ...
    res.redirect('/v9-your-companies/chs-sign-in-email')
...
router.post('/v9-your-companies/chs-sign-in-email', function (req, res) {

  //If they have a GOV.UK One Login account
if (req.session.data['set-journey'].includes('public-beta-linked')) {
       
   res.redirect('/v9-your-companies/sign-in-using-one-login')
 }
 else{

  res.redirect('/v9-your-companies/chs-sign-in-password')
...
//start page
router.post('/v9-your-companies/enter-email-address', function (req, res) {
...
//start page
router.post('/v9-your-companies/start-page', function (req, res) {
...
//One login sign in
router.post('/v9-your-companies/one-login-enter-password', function (req, res) {
  ...
  //sign in
  router.post('/v9-your-companies/enter-code', function (req, res) {


    if (req.session.data['set-journey'] === 'private-beta-not-linked') {
        
      res.redirect('/v9-your-companies/end-linking-private-beta')
    }
    else if (req.session.data['set-journey'] === 'different-email') {
        
      res.redirect('/v9-your-companies/sign-in-details-do-not-match')
    }
    else if (req.session.data['set-journey'] === 'wrong-url') {
        
      res.redirect('/v9-your-companies/stop-screen-use-url-sign-in')
    } 
    else{
  ...
  router.post('/v9-your-companies/create-enter-email', function (req, res) {
  
    res.redirect('create-check-your-email')
  })
  
  //One loginsign create - check email 
  router.post('/v9-your-companies/create-check-your-email', function (req, res) {
  ...
  //One loginsign create - check email 
  router.post('/v9-your-companies/create-enter-password', function (req, res) {
  
    res.redirect('create-choose-security-type')
  })
  
  //One loginsign create - check email 
  router.post('/v9-your-companies/create-choose-security-type', function (req, res) {
  ...
  router.post('/v9-your-companies/create-set-up-auth-app', function (req, res) {
  ...
  router.post('/v9-your-companies/create-enter-mobile-number', function (req, res) {
  
    res.redirect('create-check-your-phone')
  })
  
  //One loginsign enter mobile number
  router.post('/v9-your-companies/create-check-your-phone', function (req, res) {
  ...
  router.post('/v9-your-companies/create-complete', function (req, res) {
    if (req.session.data['set-journey'] === 'private-beta-not-linked') {
  ...
  //One loginsign create complete
  router.post('/v9-your-companies/name', function (req, res) {
  ...
  //One loginsign create complete
  router.post('/v9-your-companies/email-preferences', function (req, res) {
  ...
  router.post('/v9-your-companies/existing-webfiling-account', function (req, res) {
  ...
  // WebFiling sign in 
  router.post('/v9-your-companies/webfiling-sign-in', function (req, res) {
   ...
   router.post('/v9-your-companies/webfiling-mfa', function (req, res) {
  ...
  router.post('/v9-your-companies/link-webfiling-accounts', function (req, res) {
  ...
  router.post('/v9-your-companies/existing-account', function (req, res) {
  ...
  router.post('/v9-your-companies/chs-sign-in', function (req, res) {
    ...
    if (req.session.data['set-journey'].includes('filer')) {
     ...
     // Private beta first time logging in 
      ...
      res.redirect('/v9-your-companies/private-beta')
    }
  ...
  //Save your Companies House information
  router.post('/v9-your-companies/link-accounts', function (req, res) {
  ...
  //do not save things on their account
     ...
     // Companies House sign in 
  router.post('/v9-your-companies/end-linking', function (req, res) {


    if (req.session.data['set-journey'].includes('filer')) {
       
      res.redirect('/v9-your-companies/company-lookup')
    }
    else{
  ...
  */
    ...
    * Add a company
    */
    router.post('/v9-your-companies/add-a-company', function (req, res) {
    ...
    */
    router.post('/v9-your-companies/confirm-company-details', function (req, res) {
       ...
       * authentication code 
       */ 
      router.post('/v9-your-companies/authentication-code', function (req, res) {
       ...
       * Manage account page
       */ 
         router.post('/v9-your-companies/chs-one-login-settings', function (req, res) {
       ...
       */ 
       router.post('/v9-your-companies/name-account', function (req, res) {
       ...
       */ 
      router.post('/v9-your-companies/email-preferences-ch', function (req, res) {
       ...
       */ 
      router.post('/v9-your-companies/email-preferences-ur', function (req, res) {
  ...
  router.get('/v9-your-companies/remove-do-not-restore-company', function (req, res) {
  ...
  router.get('/v9-your-companies/restore-test-company', function (req, res) {
