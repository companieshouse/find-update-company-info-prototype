...
router.post('/v5/upload-a-document', function (req, res) {
...
router.post('/v5/choose-sign-in', function (req, res) {
...
if (req.session.data['set-journey'].includes('account-linked')) {
 ...
 //  **TODO** If they are an Admin user .includes @companieshouse.gov.uk we need to handle -> admin && account already migrated 
   ...
   res.redirect('/v5/chs-sign-in-password')
 } 
...
//start page
router.post('/v5/enter-email-address', function (req, res) {
...
//One login sign in
router.post('/v5/one-login-enter-password', function (req, res) {
  ...
  //sign in
  router.post('/v5/enter-code', function (req, res) {
  ...
  router.post('/v5/create-enter-email', function (req, res) {
  
    res.redirect('create-check-your-email')
  })
  
  //One loginsign create - check email 
  router.post('/v5/create-check-your-email', function (req, res) {
  ...
  //One loginsign create - check email 
  router.post('/v5/create-enter-password', function (req, res) {
  
    res.redirect('create-choose-security-type')
  })
  
  //One loginsign create - check email 
  router.post('/v5/create-choose-security-type', function (req, res) {
  ...
  router.post('/v5/create-set-up-auth-app', function (req, res) {
  ...
  router.post('/v5/create-enter-mobile-number', function (req, res) {
  
    res.redirect('create-check-your-phone')
  })
  
  //One loginsign enter mobile number
  router.post('/v5/create-check-your-phone', function (req, res) {
  ...
  router.post('/v5/create-complete', function (req, res) {
  ...
  //One loginsign create complete
  router.post('/v5/email-preferences', function (req, res) {
  ...
  router.post('/v5/existing-webfiling-account', function (req, res) {
  ...
  // WebFiling sign in 
  router.post('/v5/webfiling-sign-in', function (req, res) {
   ...
   router.post('/v5/webfiling-mfa', function (req, res) {
  ...
  router.post('/v5/link-webfiling-accounts', function (req, res) {
  ...
  router.post('/v5/existing-account', function (req, res) {
  ...
  router.post('/v5/chs-sign-in', function (req, res) {
  ...
  //Save your Companies House information
  router.post('/v5/link-accounts', function (req, res) {
  ...
  //do not save things on their account
     ...
     // Companies House sign in 
  router.post('/v5/end-linking', function (req, res) {


    if (req.session.data['set-journey'].includes('filer')) {
       
      res.redirect('/v5/company-lookup')
    }
    else{
  ...
  */
    ...
    * Add a company
    */
    router.post('/v5/add-a-company', function (req, res) {
    ...
    */
    router.post('/v5/confirm-company-details', function (req, res) {
       ...
       * authentication code 
       */ 
      router.post('/v5/authentication-code', function (req, res) {
