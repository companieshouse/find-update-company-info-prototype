...
router.post('/v6/choose-sign-in', function (req, res) {
...
if (req.session.data['set-journey'].includes('account-linked')) {
 ...
 //  **TODO** If they are an Admin user .includes @companieshouse.gov.uk we need to handle -> admin && account already migrated 
   ...
   res.redirect('/v6/chs-sign-in-password')
 } 
...
//start page
router.post('/v6/enter-email-address', function (req, res) {
...
router.post('/v6/one-login-enter-password', function (req, res) {
  ...
  //sign in
  router.post('/v6/enter-code', function (req, res) {
  ...
  router.post('/v6/create-enter-email', function (req, res) {
  
    res.redirect('create-check-your-email')
  })
  
  //One loginsign create - check email 
  router.post('/v6/create-check-your-email', function (req, res) {
  ...
  //One loginsign create - check email 
  router.post('/v6/create-enter-password', function (req, res) {
  
    res.redirect('create-choose-security-type')
  })
  
  //One loginsign create - check email 
  router.post('/v6/create-choose-security-type', function (req, res) {
  ...
  router.post('/v6/create-set-up-auth-app', function (req, res) {
  ...
  router.post('/v6/create-enter-mobile-number', function (req, res) {
  
    res.redirect('create-check-your-phone')
  })
  
  //One loginsign enter mobile number
  router.post('/v6/create-check-your-phone', function (req, res) {
  ...
  router.post('/v6/create-complete', function (req, res) {
  ...
  //One loginsign create complete
  router.post('/v6/email-preferences', function (req, res) {
  ...
  router.post('/v6/existing-webfiling-account', function (req, res) {
  ...
  // WebFiling sign in 
  router.post('/v6/webfiling-sign-in', function (req, res) {
   ...
   router.post('/v6/webfiling-mfa', function (req, res) {
  ...
  router.post('/v6/link-webfiling-accounts', function (req, res) {
  ...
  router.post('/v6/existing-account', function (req, res) {
  ...
  //Save your Companies House information
  router.post('/v6/link-accounts', function (req, res) {
  ...
  //do not save things on their account
     ...
     // Companies House sign in 
  router.post('/v6/end-linking', function (req, res) {


    if (req.session.data['set-journey'].includes('filer')) {
       
      res.redirect('/v6/company-lookup')
    }
    else{
  ...
  */
    ...
    * Add a company
    */
    router.post('/v6/add-a-company', function (req, res) {
    ...
    */
    router.post('/v6/confirm-company-details', function (req, res) {
       ...
       * authentication code 
       */ 
      router.post('/v6/authentication-code', function (req, res) {
       ...
       * Manage account page
       */ 
         router.post('/v6/chs-one-login-settings', function (req, res) {
       ...
       */ 
       router.post('/v6/name-account', function (req, res) {
       ...
       */ 
      router.post('/v6/email-preferences-ch', function (req, res) {
       ...
       */ 
      router.post('/v6/email-preferences-ur', function (req, res) {
